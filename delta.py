...
from PGCP_delay_flights import flights
    ...
    html.Div(className = "row",
             children=[ 
                 ...
                 html.Div(className="two columns",
                          children = [
                              html.Center(html.H2("Delta data")),
                              ...
                              html.Br(),
                              dcc.Link(html.Button('Annule', style={'width':"100%"}), href='/flights'),
                              html.Br(),
                              html.Br(),
