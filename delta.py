            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Link(
                            html.Button("Prix d'énergies", style={"width": "100%"}),
                            href="/energies",
                        ),
                        html.Br(),
                        dcc.Link(
                            html.Button("Natalité vs revenus", style={"width": "100%"}),
                            href="/population",
                        ),
                        html.Br(),
                        dcc.Link(
                            html.Button("Décès journaliers", style={"width": "100%"}),
                            href="/deces",
                        ),
                        html.Br(),
                        dcc.Link(
                        ...
                        html.Center(
                            html.A(
                                "Code source", href="https://github.com/oricou/delta"
                            )
                        ),
                    ],
                ),
