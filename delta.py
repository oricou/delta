             ...
             children=[ 
                 ...
                 html.Div(className="two columns",
                          children = [
                              ...
                              dcc.Link(html.Button("Nombre de station", style={'width':"150%"}), href='/australiaweather'),
                              html.Br(),
                              dcc.Link(html.Button('Répartition/quantité mesures', style={'width':"150%"}), href='/mesureweather'),
                              html.Br(),
                              dcc.Link(html.Button('Précipitation/prix de l\'eau', style={'width':"150%"}), href='/watercost'),
                              html.Br(),
                              html.Br(),
                          ]),
