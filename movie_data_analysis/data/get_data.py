...
df = pd.read_csv("movies_data_analysis/data/movies_metadata.csv", dtype={'popularity': 'str'})
...
section1.to_csv("evolution_production/data/production.csv")
...
section2.to_csv("critique_budget/data/critique_budget.csv")
...
section3.to_csv("theme_popularite/data/theme_popularite.csv")
...
companies.to_csv("producteurs/data/entreprises_producteurs.csv")
countries.to_csv("producteurs/data/pays_producteurs.csv")
...
section5.to_csv("keywords_popularite/data/keywords_popularite.csv")