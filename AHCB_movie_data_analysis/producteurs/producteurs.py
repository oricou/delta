...
class Producer():
    ...
    def __init__(self, application = None):
        ...
        df_entreprises = pd.read_csv("AHCB_movie_data_analysis/producteurs/data/entreprises_producteurs.csv")
        df_pays = pd.read_csv("AHCB_movie_data_analysis/producteurs/data/pays_producteurs.csv")
        dfpb = df_pays.copy()
