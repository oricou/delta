...
os.makedirs("AHCB_movie_data_analysis/evolution_production/data", exist_ok=True)
os.makedirs("AHCB_movie_data_analysis/critique_budget/data", exist_ok=True)
os.makedirs("AHCB_movie_data_analysis/keywords_popularite/data", exist_ok=True)
os.makedirs("AHCB_movie_data_analysis/producteurs/data", exist_ok=True)
os.makedirs("AHCB_movie_data_analysis/theme_popularite/data", exist_ok=True)


df = pd.read_csv("AHCB_movie_data_analysis/data/movies_metadata.csv", dtype={'popularity': 'str'})
...
section1.to_csv("AHCB_movie_data_analysis/evolution_production/data/production.csv")
...
section2.to_csv("AHCB_movie_data_analysis/critique_budget/data/critique_budget.csv")
...
section3.to_csv("AHCB_movie_data_analysis/theme_popularite/data/theme_popularite.csv")
...
companies.to_csv("AHCB_movie_data_analysis/producteurs/data/entreprises_producteurs.csv")
countries.to_csv("AHCB_movie_data_analysis/producteurs/data/pays_producteurs.csv")
...
section5.to_csv("AHCB_movie_data_analysis/keywords_popularite/data/keywords_popularite.csv")